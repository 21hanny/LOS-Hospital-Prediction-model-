...
Team: Me(Sourabh saini) ,Maximilian, Tobias, Raghvendra.

Analyzes Hospital data to predict patient Length of Stay (LOS) using regression modeling and feature engineering. Data cleaning, encoding, and visualization are applied to uncover key predictors and support healthcare decision-making.
Team: Me(Sourabh saini) ,Maximilian, Tobias, Raghvendra.
